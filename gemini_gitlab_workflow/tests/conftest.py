...
def isolated_filesystem(mocker, tmp_path):
    ...
    mocker.patch('gemini_cli.PROJECT_MAP_PATH', str(project_map_path))
    mocker.patch('gemini_cli.DATA_DIR', str(data_dir))
    mocker.patch('gitlab_service.DATA_DIR', str(data_dir))
